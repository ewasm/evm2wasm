...
(func $ISZERO
  ...
  (set_local $a0 (i64.load (i32.sub (get_local $sp) (i32.const 8))))
  (set_local $a1 (i64.load (i32.sub (get_local $sp) (i32.const 16))))
  (set_local $a2 (i64.load (i32.sub (get_local $sp) (i32.const 24))))
  (set_local $a3 (i64.load (i32.sub (get_local $sp) (i32.const 32))))

  ;; decement the stack pointer
  ;; (set_local $sp )

  (i64.store (i32.sub (get_local $sp) (i32.const 32))
    (i64.extend_u/i32
