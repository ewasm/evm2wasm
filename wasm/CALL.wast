  ...
  (param $callback i32)(local $offset0 i32)(local $length0 i32)(local $offset1 i32)(local $length1 i32)(local $memstart i32) (set_local $memstart (i32.const 33832)) (set_local $offset0 
    ...
    (i64.extend_u/i32
      (call_import $call(call $check_overflow_i64
           ...
           (i64.load (i32.add (get_local $sp) (i32.const 24))))(i32.add (get_local $sp) (i32.const -32))(i32.add (get_local $sp) (i32.const -64))(get_local $offset0)(get_local $length0)(get_local $offset1)(get_local $length1)(get_local $callback))))
