...
(func $EXP
  ...
  (loop $done $loop
    ...
    (if (i64.eqz (i64.ctz (get_local $b3)))
      ...
      ;; r = r * a
      (then
        (call $MUL_256 (get_local $r0) (get_local $r1) (get_local $r2) (get_local $r3) (get_local $a0) (get_local $a1) (get_local $a2) (get_local $a3) (i32.add (get_local $sp) (i32.const 24)))
    ...
    (call $MUL_256 (get_local $a0) (get_local $a1) (get_local $a2) (get_local $a3) (get_local $a0) (get_local $a1) (get_local $a2) (get_local $a3) (i32.add (get_local $sp) (i32.const 24)))
    (set_local $a0 (i64.load (i32.add (get_local $sp) (i32.const 24))))
    (set_local $a1 (i64.load (i32.add (get_local $sp) (i32.const 16))))
    (set_local $a2 (i64.load (i32.add (get_local $sp) (i32.const  8))))
    (set_local $a3 (i64.load          (get_local $sp)))
