(func $DUP
  ...
  ;; FIXME: remove const0
  (i64.store (i32.add (get_local $sp) (i32.const 0))  (i64.load (i32.sub (get_local $sp_ref) (i32.const 24))))
  ...
  (i64.store (i32.add (get_local $sp) (i32.const 24)) (i64.load (i32.sub (get_local $sp_ref) (i32.const 0))))
