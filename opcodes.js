const codes = {
  ...
  0x32: ['ORIGIN', 0, 0, 1, true],
  0x33: ['CALLER', 0, 0, 1, true],
  0x34: ['CALLVALUE', 0, 0, 1, true],
  0x35: ['CALLDATALOAD', 0, 1, 1, true],
  0x36: ['CALLDATASIZE', 0, 0, 1, true],
  0x37: ['CALLDATACOPY', 0, 3, 0, true],
  0x38: ['CODESIZE', 0, 0, 1, false],
  0x39: ['CODECOPY', 0, 3, 0, false],
  0x3a: ['GASPRICE', 0, 0, 1, false],
  0x3b: ['EXTCODESIZE', 0, 1, 1, true],
  0x3c: ['EXTCODECOPY', 0, 4, 0, true],
